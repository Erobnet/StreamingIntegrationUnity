...
using PersistData= GameProject.Persistence.CommonData.SkinColorOptions;
using FixedString = Unity.Collections.FixedString512Bytes;

namespace GameProject.Persistence.CommonData
{
    public struct SkinColorOptions
    {
        public FixedList64Bytes<byte> Indices;
        
        public FixedString ToFixedString()
        {
            var result = new FixedString();
            result.Append((FixedString32Bytes)nameof(SkinColorOptions));
        ...
        public unsafe struct BinaryAdapter : ICustomBinarySerializer<SkinColorOptions>
        {
